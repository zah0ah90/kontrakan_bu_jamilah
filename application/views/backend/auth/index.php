...
<head>
    ...
    <title>Sistem Informasi Kontrakan Bu Jamilah</title>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">
                                Sistem Informasi <b> Kontrakan Bu Jamilah </b>
                            </p>
                        </div>
                                ...
                                <div class="m-sm-4">
                                    ...
                                    <form action="<?= base_url() ?>auth/process" method="post">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <button type="submit" name="login" style="float:right;"
                                                class="btn btn-lg btn-primary">Masuk
                                            </button>
                                        </div>
                                    </form>
                                </div>
