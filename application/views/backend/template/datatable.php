...
<link rel="stylesheet"
    href="<?= base_url('assets/static/') ?>plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
<link rel="stylesheet"
    href="<?= base_url('assets/static/') ?>plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
